...
/*
 * TODO:
 * - Implement Session store as standard Session store instead of storing data in cookie 
 * - Document ALL options and functions
 * - TESTS!!!!!!!!!!!!
 */
 
var serializer = require('serializer'),
    UserStore = require('./index.js').UserStore;
...
var Authentication = module.exports = function(options) {
  ...
  // users database
  //
  this.users = options.users  || new UserStore();
  //
 ...
 * user id as argument.  
 */
Authentication.prototype.enforceLogin = function(req, res, cbUrl, next) {
 ...
 */
Authentication.prototype.getLogin = function(req, res, next) {
  var session = this.getSessionData(req) || {},
 ...
 * @param {Function} next Function to execute next 
 */
Authentication.prototype.postLogin = function(req, res, next) {
  var self = this,
      body = req.body || {},
      nextUrl = body.next || '/',
      username;
 ...
 * @param {Function} next Function to execute next 
 */
Authentication.prototype.getLogout = function(req, res, next) {
 ...
 */
Authentication.prototype.showLogin = function(req, res, next, nextUrl) {
  res.end(
 ...
 */
Authentication.prototype.error_wrong_parameters = function(req, res) {
