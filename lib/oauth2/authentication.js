 ...
 * given callback url.This function is called when the OAuth2 core wants to know if this user 
...
Authentication.prototype.login = function(req, res, cb_url, options, next) {
  ...
  // login data returned in POST ? handle it
  ...
  // show login page
  return this.showLogin(req, res, next, cb_url);
}
