 ...
 */
exports.invalid_client = function(req, res, options) {
  //
  // TODO: check if 401 response needs to be returned see 5.2 error description
  // var header = "Basic realm=\"" + authentication_realm;
