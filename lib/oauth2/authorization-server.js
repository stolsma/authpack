...
AuthorizationServer.prototype.authorizeScope = function(req, res, cb_url, options, next) {
  ...
  var auth_key = this.serializer.stringify([+new Date, serializer.randomString(128)]);
