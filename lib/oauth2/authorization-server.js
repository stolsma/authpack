...
AuthorizationServer.prototype.implicitGrant = function(req, res, options) {
  ...
  this.authorization.generateAccessToken(options.user_id, options.client_id, function(err, access_token) {
...
AuthorizationServer.prototype.tokenEndpoint = function(req, res, next) {
  req.body = req.body || {};
  var self = this,
      grant_type = req.body.grant_type,         // 'authorization_code' (4.1.3), 'password' (4.3.2),
  ...
  self.authorization.checkCode(client_id, code, function(err, user_id) {
    if (err) {
      res.writeHead(400);
    ...
    self.authorization.generateAccessToken(user_id, client_id, function(err, access_token) {
      self.authorization.generateCode(user_id, client_id, function(err, refresh_token) {
        var result = {
...
AuthorizationServer.prototype.authorizationCodeGrant = function() {
};

AuthorizationServer.prototype.passwordGrant = function() {
};

AuthorizationServer.prototype.clientCredentialsGrant = function() {
};
